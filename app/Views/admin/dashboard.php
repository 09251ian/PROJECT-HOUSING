...
<body class="app-dark">
  ...
  <div class="container py-4">
    ...
    <!-- FIXED: All 4 cards in one row -->
    <div class="row g-3">
      <!-- Buyers Card -->
      <div class="col-md-3 col-sm-6">
        <div class="app-card">
          <div class="app-card-title">Buyers</div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="app-card">
          <div class="app-card-title">Sellers</div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="app-card">
          <div class="app-card-title">Properties</div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="app-card">
          <div class="app-card-title">Offers</div>
    ...
    <!-- Payments Card - Separate row below -->
    <div class="row mt-4">
      <div class="col-md-12">
        <div class="app-card p-3">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <div class="app-card-title">Payments (Transactions)</div>
              <div class="app-card-value text-primary" id="payments-count">
                <?= htmlspecialchars((string)($paymentsCount ?? 0), ENT_QUOTES, 'UTF-8') ?>
              </div>
            </div>
            <a href="<?= base_url('/admin/payments') ?>" class="btn btn-outline-primary">Manage Payments</a>
          </div>
        </div>
      </div>
    </div>
